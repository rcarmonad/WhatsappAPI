(function() {
	...
	*/
		...
		this.ExternalHandlers = {
			...
			*/
			...
			Parameters:
				...
				3. Parsed Msg object
			*/
			MESSAGE_RECEIVED: [ echoesMessage ]
		};
	...
	// own functions
	/*
	Echoes message to sender for testing purpouses
	*/
	var echoesMessage = function(sender, chat, msg){
		var text = msg.__x_text;
		var chat_id = msg.__x_chat.__x_id;

		window.API.sendTyping(chat_id);

		window.API.sendTextMessage(chat_id, "[BOT] Tu mensaje fue: "+text, function(a){
			console.log(a);
		})
	};
